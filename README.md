...
HTML5 para la estructura semántica 🏗️
...
- API de TheSportsDB para la base de datos 🗄️

📁 Estructura del Código
El proyecto se divide en tres pilares fundamentales: 🏛️
...
- App js que gestiona los flujos de datos de búsqueda de jugador consulta de honores e historial de equipos ⚙️
